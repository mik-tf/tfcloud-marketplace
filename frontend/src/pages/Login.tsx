  ...
  return (
    <div className="max-w-md mx-auto py-10 text-gray-900 dark:text-gray-100">
      ...
      <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-700 rounded">
        ...
        <p className="text-sm mb-1"><strong>Cloud Operator:</strong> operator@example.com / password</p>
        <p className="text-sm mb-1"><strong>Cloud Provider:</strong> provider@example.com / password</p>
